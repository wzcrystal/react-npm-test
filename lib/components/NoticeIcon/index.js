...
var NoticeIcon = (_temp2 = _class = function (_PureComponent) {
  ...
  _createClass(NoticeIcon, [{
    ...
    value: function render() {
      ...
      var NoticeBellIcon = bell || _react2.default.createElement(_icons.BellOutlined, { className: _index2.default.icon });
      var trigger = _react2.default.createElement(
        'span',
        { className: (0, _classnames2.default)(noticeButtonClass, { opened: visible }) },
        _react2.default.createElement(
          _antd.Badge,
          { count: count, offset: [0, 2], style: { boxShadow: 'none' }, className: _index2.default.badge },
          NoticeBellIcon
        )
      );
      if (!notificationBox) {
      ...
      return _react2.default.createElement(
        ...
        _extends({
          ...
          overlayClassName: _index2.default.popover,
          trigger: ['click'],
          visible: visible,
