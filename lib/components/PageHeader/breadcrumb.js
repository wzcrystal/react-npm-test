  ...
  function BreadcrumbView() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BreadcrumbView.__proto__ || Object.getPrototypeOf(BreadcrumbView)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return _react2.default.createElement(
        _antd.Breadcrumb,
        { className: _index2.default.breadcrumb, separator: breadcrumbSeparator },
      ...
      if (routes && params) {
        return _react2.default.createElement(_antd.Breadcrumb, {
          className: _index2.default.breadcrumb,
